...
namespace BattleCampusMatchServer.Services
{
    public class MatchManager : IMatchManager
    {
        ...
        public void ConnectUser(string serverIp, GameUser user)
        {
        ...
        public MatchJoinResult JoinMatch(string serverIp, string matchID, GameUser user)
        {
        ...
        public void NotifyPlayerExitGame(string serverIp, string matchID, GameUser user)
        {
            var serverExists = Servers.TryGetValue(serverIp, out var server);
